...
Config.DoorList = {
		...
		-- OFFICE DOOR
	{
		...
		objCoords  = {x = 128.89, y = -1322.21, z = 29.20},
		textCoords = {x = 129.74, y = -1316.95, z = 29.11},
		authorizedJobs = { 'unicorn', 'police', 'tequilala' },
		locked = true,
		gate = true,
		distance = 120,
		size = 1
	...
	{
		objName = 'prop_lrggate_02_ld',  
		objCoords  = {x = 159.85, y = -1331.77, z = 29.31},
		textCoords = {x = 155.38, y = -1328.44, z = 29.21},
		authorizedJobs = { 'unicorn', 'police', 'tequilala' },
		locked = true,
		gate = true,
		distance = 120,
...

	{
		...
		authorizedJobs = { 'bahama_mamas', 'police' },
		locked = false,
		distance = 120
	},
...

	{
		...
		authorizedJobs = { 'mafia', 'police', 'ambulance' },
		locked = true,
		gate = true,
		distance = 120,
		size = 1
...
-- Tequila-la Doors
 ...
 
	{
		...
		authorizedJobs = { 'tequilala', 'police' },
		locked = true,
		distance = 120
	},
...
--- Benny's
	{
		...
		authorizedJobs = { 'mechanic', 'police', 'ambulance' },
		gate = true,
		locked = true,
		distance = 120
	},
...
--- Yellow Jack

	{
		...
		authorizedJobs = { 'yellowjack', 'police' },
		locked = true,
		distance = 120
	},
...
-- Glass doors
	-- Entrance
	{
		...
		authorizedJobs = { 'cardealer', 'unicorn', 'police', 'ambulance' },
		locked = true,
		distance = 120
	},
		...
		-- Office
	{
		...
		authorizedJobs = { 'cardealer', 'unicorn' },
		locked = true,
		distance = 120
	},
